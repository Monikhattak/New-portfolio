...
function About() {
  return (
    <div id="about" className='w-full px-[12%] py-10 scroll-mt-20'>
      <h4 className='text-center mt-20 mb-2 text-lg font-semibold text-gray-700'>Introduction</h4>
      <h2 className='text-center text-5xl font-bold text-gray-900'>About Me</h2>
      <div className='w-full flex flex-col lg:flex-row items-center gap-20 my-20 relative'>
        ...
        <div className=' bg-slate-200 w-1/2  aspect-square  absolute right-0 bottom-0 
         rounded-full translate-x-1/4 translate-y-1/3  shadow-[0_4px_55ppx_ rgba(140, 0, 162, 0.1)]
          ...
          <img className='w-full' src={circular_icon} alt="Circular Icon" />
        ...
        <div className='flex-1'>
          ...
          <h4 className='my-6 text-gray-700 text-lg font-semibold'>Tools I Use</h4>
